...
export var PRODUCT_HERO_EYEBROW = "Billing for Nepal distribution";
/** Login / register / hero — main headline (audience-first) */
export var PRODUCT_TAGLINE = "Built for distributors, dealers & stockists";
/** Login / register / hero — phone wedge + offer (no NPR here; see #pricing) */
export var PRODUCT_TAGLINE_DETAIL = "Tax invoices, godown stock, and customer credit — from your phone. One affordable plan per company.";
/** Browser tab title and PWA name */
export var BRAND_HTML_TITLE = PRODUCT_DISPLAY_NAME;
/** PWA install / manifest */
export var PWA_DESCRIPTION = "Tax invoices, godown stock, and customer credit for Nepal distributors and dealers.";
