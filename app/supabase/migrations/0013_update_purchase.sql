-- Edit an existing purchase (lines, supplier, date). Stock follows purchase_items via v_stock.
-- Does not change `paid`; new total must be >= amount already paid on the purchase.
